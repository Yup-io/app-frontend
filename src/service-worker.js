...
registerRoute(
  ...
  ({ url }) =>
    ...
    url.pathname
      .split('.')
      .pop()
      .match(/^(png|css|svg|woff2)$/), // Customize this strategy as needed, e.g., by changing to CacheFirst.
  new CacheFirst({
    cacheName: 'static',
    plugins: [
...
registerRoute(
  ({ url }) =>
    url.origin === 'https://gilroy-web-fonts.s3.amazonaws.com' ||
...
registerRoute(
  ({ url }) =>
    ...
    url.origin === 'https://cdn.segment.com' ||
    url.origin === 'http://cdn4.mxpnl.com',
  new CacheFirst({
    cacheName: 'scripts',
    plugins: [
      new CacheableResponsePlugin({
