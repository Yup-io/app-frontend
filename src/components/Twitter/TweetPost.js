...
const RetweetedTweet = {
  ...
  user: {
    ...
    description:
      "Emmy award-winning journalist; Sr. Entertainment Reporter for @ESPN's @TheUndefeated. Formerly of @BuzzFeed, @USAToday, @Freep, @ChicagoTribune and @EbonyMag",
    ...
    profile_image_url:
      'http://pbs.twimg.com/profile_images/739921401629413376/_Pfdcffn_normal.jpg',
    profile_image_url_https:
      'https://pbs.twimg.com/profile_images/739921401629413376/_Pfdcffn_normal.jpg',
    profile_banner_url:
      'https://pbs.twimg.com/profile_banners/16138216/1482963610',
...
const OriginalTweet = {
  ...
  text: 'Before the 3,000 passengers and crew docked on Monday, officials announced plans to take them to military bases fo… https://t.co/Df0T5l9IfD',
  truncated: true,
  entities: {
    hashtags: [],
    symbols: [],
