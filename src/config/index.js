...
export const voteCategories =
  process.env.NEXT_PUBLIC_VOTE_CATEGORIES.split(',');
export const professorCategories =
  process.env.NEXT_PUBLIC_PROF_CATEGORIES.split(',');
export const mapsCategories =
  process.env.NEXT_PUBLIC_MAPS_CATEGORIES.split(',');
export const courseCategories =
  process.env.NEXT_PUBLIC_COURSE_CATEGORIES.split(',');
export const electionCategories =
  process.env.NEXT_PUBLIC_ELECTION_CATEGORIES.split(',');
export const nftArtCategories =
  process.env.NEXT_PUBLIC_NFT_ART_CATEGORIES.split(',');
export const nftMusicCategories =
  process.env.NEXT_PUBLIC_NFT_MUSIC_CATEGORIES.split(',');
